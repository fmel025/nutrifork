...
export default function Settings() {
    ...
    return (
        <div className="flex flex-col justify-between font-Poppins h-fit w-full lg:min-h-screen bg-white">
            ...
            <section className="flex h-full p-10 gap-20">
                <div className="flex flex-col border-2 border-dark-green rounded-md gap-1 bg-accent-green w-[280px] h-fit p-4 shadow-[0_4px_10px_2px_rgb(0,0,0,0.25)]">
                    <a href="#informacion" className="flex justify-start btn btn-sm text-base font-normal text-white border-0 shadow-none hover:bg-hover-green h-10 w-full">Información personal</a>
                    <a href="#detalles" className="flex justify-start btn btn-sm text-base font-normal text-white border-0 shadow-none hover:bg-hover-green h-10 w-full">Detalles de la cuenta</a>
                </div>
                ...
                <div className="flex-1">
                    ...
                    <form className="w-full">
                        <p className="py-3 text-sm md:text-base text-black font-normal">Nombre</p>
                        <input value={userData.name} onChange={handleChange} type="text" className="input h-10 rounded-md input-bordered focus:border-2 focus:outline-0 w-full" />
                        <p className="py-3 text-sm md:text-base text-black font-normal">Usuario</p>
                        <input value={userData.username} onChange={handleChange} type="text" className="input h-10 rounded-md input-bordered focus:border-2 focus:outline-0 w-full" />
                        <p className="py-3 text-sm md:text-base text-black font-normal">Correo electrónico</p>
                        <input value={userData.email} onChange={handleChange} type="email" className="input h-10 rounded-md input-bordered focus:border-2 focus:outline-0 w-full" />
                        <p className="py-3 text-sm md:text-base text-black font-normal">Contraseña</p>
                        <input value={userData.password} onChange={handleChange} type="password" className="input h-10 rounded-md input-bordered focus:border-2 focus:outline-0 w-full" />
