...
export default function Recipes({ loggedIn }) {
    ...
    <div className="lg:w-[35%] p-4">
        <img src="/src/assets/food-1.webp" alt="Chili Mac & Cheese" className="w-full lg:w-80 hidden lg:block" />
        <div className="bg-accent-green text-white p-4 rounded-md mt-4">
