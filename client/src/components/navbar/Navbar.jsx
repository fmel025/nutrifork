            ...
            <div className="flex-none">
                <ul className="menu menu-horizontal gap-4">
                    ...
                    {loggedIn ? (
                        ...
                        <Link to={'/iniciar-sesion'}><li className="hidden md:block btn btn-sm h-10 border-1 border-black text-sm md:text-base text-black font-normal rounded-md shadow-none hover:bg-accent-green hover:text-white"><a>Inicia sesión</a></li></Link>
                    )}
                </ul>
            </div>
        </div>
